...
$(window).ready(function(){
    ...
    let accesstoffset = $('section.access h2').offset().top/1.3;
    let contactTitleOffset = $('section.contact h2').offset().top/1.2;
    let galleryimgoffset1 = $('.imgWrapper_1').offset().top/1.20; 
    let galleryimgoffset2 = $('.imgWrapper_2').offset().top/1.20; 
    let galleryimgoffset3 = $('.imgWrapper_3').offset().top/1.20; 
    let galleryimgoffset4 = $('.imgWrapper_4').offset().top/1.20; 
    let galleryimgoffset5 = $('.imgWrapper_5').offset().top/1.20;
    let galleryimgoffset6 = $('.imgWrapper_6').offset().top/1.20; 
    $(window).scroll(function(){
        let scroll = $(this).scrollTop() + $(window).height()/1.5;

...
$(window).ready(function(){
    ...
    let galleryimgoffset1 = $('.imgWrapper_1').offset().top/1.25; 
    let galleryimgoffset2 = $('.imgWrapper_2').offset().top/1.25; 
    let galleryimgoffset3 = $('.imgWrapper_3').offset().top/1.25; 
    let galleryimgoffset4 = $('.imgWrapper_4').offset().top/1.25; 
    let galleryimgoffset5 = $('.imgWrapper_5').offset().top/1.25;
    let galleryimgoffset6 = $('.imgWrapper_6').offset().top/1.25; 
    $(window).scroll(function(){

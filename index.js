...
$(window).ready(function(){
    ...
    let galleryimgoffset1 = $('.imgWrapper_1').offset().top-80; 
    let galleryimgoffset2 = $('.imgWrapper_2').offset().top-80; 
    let galleryimgoffset3 = $('.imgWrapper_3').offset().top-80; 
    let galleryimgoffset4 = $('.imgWrapper_4').offset().top-80; 
